...
solver = Solver()
train_data = read_data("bc.train")
got_all = solver.train(train_data)
# print "got all"
# d1 =  got_all[1]
# for e in d1:
#   print e
...
for (s, gt) in test_data:
    ...
    for (algo, label) in zip(Algorithms, Algorithm_labels):
        outputs[label] = solver.solve(algo, s, got_all)
